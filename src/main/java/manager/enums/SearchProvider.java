...
public enum SearchProvider {
    CAP("Cover Art Project",
     "The Cover Art Project is a collective initiative to archive and share album cover art. It provides a platform for exploration of various eras of music through their cover art, serving as an open resource for music enthusiasts and researchers alike. WARNING: This uses webscraping and is very slow, experiemental"),
    SGDB("SteamGridDB",
