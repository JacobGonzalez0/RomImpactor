...
public class ImageCropperPanelControllerOld {
    @FXML
    ...
    private void resizeFromNW(MouseEvent event) {
        ...
        if (newWidth > 0 && newHeight > 0 && isWithinImageView(newX, newY, newWidth, newHeight)) {
            visibleCropRectangle.setX(newX);
            visibleCropRectangle.setY(newY);
            visibleCropRectangle.setWidth(newWidth);
            visibleCropRectangle.setHeight(newHeight);
        }
        updateVisibleCropRectangle();
    }
    ...
    private void move(MouseEvent event) {
        ...
        System.out.println("xV:" + visibleCropRectangle.getX());
